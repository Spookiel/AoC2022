...
applyInst2 :: Wharf -> Instruction -> Wharf
applyInst2 wharf [0 ,b,c] = wharf
applyInst2 wharf [n,b,c] = applyInst1 nwharf2 [0,b,c] where
    ostack1 = wharf!!(b-1)
    ostack2 = wharf!!(c-1)
    (nstack1, nstack2) = moveN n ostack1 ostack2
    nwharf1 = replaceStack wharf (b-1) nstack1
    nwharf2 = replaceStack nwharf1 (c-1) nstack2
